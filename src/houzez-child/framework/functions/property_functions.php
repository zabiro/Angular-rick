...
if( !function_exists('houzez_listing_model')) {
    function houzez_listing_model() {
        ...
        $gall = houzez_get_property_gallery($listing_id);
        $size = 'houzez-gallery';
    ...
    <div class="modal-body clearfix">
        ...
        <div class="lightbox-content-wrap lightbox-form-wrap">
               ...
               $listing_data_composer = houzez_option('preview_data_composer');
                ...
                if ($data_composer) {
                    ...
                    unset($data_composer['placebo']);
                        ...
                        $additional_features = get_post_meta($listing_id, 'additional_features', true);
                            foreach ($additional_features as $adf) {
                                if (isset($adf['fave_additional_feature_title']) && !empty($adf['fave_additional_feature_title'])) {
                                    if ($adf['fave_additional_feature_title'] == 'area_hasta') {
                                        $area_hasta = $adf['fave_additional_feature_value'];
                                    }
                                    if ($adf['fave_additional_feature_title'] == 't_construccion') {
                                        $tipo_construccion = $adf['fave_additional_feature_value'];
                                    }
                                }
                            }

                        if(isset($area_hasta) && $area_hasta != ''){
                        $cust_output .= "<li class='h-area-hasta'>
                            <span> <p>Hasta</p><p>$area_hasta m²</p>  </span>
                        </li>";
                        }
                         if(isset($tipo_construccion) && $tipo_construccion != ''){
                        $cust_output .= "<li class='h-tipo-construccion'>
                            <span><p>CONSTRUCCIÓN</p><p>$tipo_construccion</p>  </span>
                        </li>";
                        }
                        ...
                        if( $key == 'bed' && $bedrooms != '' ) {
                            ...
                            $area_size_output .= '<ul class="list-unstyled flex-fill">';
                                $area_size_output .= '<li class="property-overview-item">';
                                    ...
                                    if(houzez_option('icons_type') == 'font-awesome') {
                                        $icon_areasize .= '<img src="/wp-content/uploads/2021/08/size.png" alt="size">';
                                    ...
                                    $area_size_output .= '<strong>' .$listing_area_size.'</strong>';
          ...
          <a class="btn btn-primary btn-item" href="<?php echo esc_url(get_permalink($listing_id)); ?>">
                <?php  echo houzez_option('glc_detail_btn', 'Contacta un asesor'); ?>
            </a><!-- btn-item -->
         <!--<button type='button' value='' onclick='showEle("<?php // echo $listing_id; ?>")'>Contacta un Asesor</button>-->
