...
if ( ! function_exists( 'elementor_theme_do_location' ) || ! elementor_theme_do_location( 'single' ) ) {
    $term_list = wp_get_post_terms( $post->ID, 'property_type', array( 'fields' => 'names' ) );

      if( have_posts() ): while( have_posts() ): the_post();
        if(in_array('Proyectos', $term_list)){?>
    ...
    <?php }elseif(in_array('Arriendos', $term_list) || in_array('compra usados', $term_list)){?>
